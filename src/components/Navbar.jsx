  ...
  return (
    <div className="container relative mx-auto text-white lg:px-20 font-poppins text-xs flex">
      <div className="logo flex items-center md:px-5">
        ...
        <FontAwesomeIcon icon={!click ? faBars:faX}className='text-2xl absolute right-5 md:right-10 cursor-pointer hover:text-blue-300  lg:hidden'
        onClick={() => {
          setClick(!click)
        }}
        />
        <nav className='uppercase text-center '>
          <ul className='flex flex-col absolute top-20 bg-blue-500 w-full left-0 gap-2 lg:sticky lg:ml-2 lg:bg-transparent'>
            {
              click ? (
